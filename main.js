...
function card_clicked(card_element){
    ...
    var card_image_back= $(card_element).find('img');
    $(card_image_back).hide();
    ...
    if (first_card_clicked == null) {
        ...
        if (first_card_clicked == second_card_clicked) {
            ...
            console.log('first_card_clicked, second_card_clicked is now... ' + first_card_clicked + ', ' + second_card_clicked + ' AGAIN. You can pick another card.')
        }
        else {
            console.log('Is it a match? No it is ' + (first_card_clicked == second_card_clicked));
            setTimeout(function(){ $(card_image_back).show(); }, 3000);
